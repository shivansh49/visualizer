...
m = input("Enter elements seperating by spaces:")
...
anima = anim.FuncAnimation(fig, func=update_plot, fargs=(bar_rec, epochs), frames=algo, interval=500, repeat=False)
#anima.save('/tmp/animation.gif', writer='imagemagick', fps=30)
Writer = anima.writers['pillow']
writer = Writer(fps=15, metadata=dict(artist='Me'), bitrate=1800)
anima.save('covid19.mp4')
plt.show()
